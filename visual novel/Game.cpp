...
void Game::setupFontAndText()
{
	...
	m_AkiraTalk.setCharacterSize(40U); 
	...
	m_HajimeText.setCharacterSize(40U); 
...
void Game::setupSprite()
{
	...
	if (!m_backGround1Texture.loadFromFile("ASSETS\\IMAGES\\bg1.jpg"))
	{
	...
	if (!m_textBoxTexture.loadFromFile("ASSETS\\IMAGES\\textbox.png"))
	{
	...
	if (!m_AkariTexture.loadFromFile("ASSETS\\IMAGES\\akari_N1.png"))
	{
		std::cout << "problem loading Akari" << std::endl;
	}
	if (!m_AkariTextureSerious.loadFromFile("ASSETS\\IMAGES\\akari_S1.png"))
	{
		std::cout << "problem loading Akari" << std::endl;
	}
	if (!m_AkariTextureHappy.loadFromFile("ASSETS\\IMAGES\\akari_H1.png"))
	{
		std::cout << "problem loading Akari" << std::endl;
	}
	m_AkariSprite.setTexture(m_AkariTexture);
